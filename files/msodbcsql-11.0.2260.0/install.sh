...
req_libs=(glibc libuuid1 krb5 openssl)

#language of the install
lang_id="en_US";

# files to be copied by directory
driver_file="libmsodbcsql-11.0.so.2260.0"

lib_files=( "lib64/$driver_file" )
lib_perms=( 0755 )

bin_files=( "bin/bcp-11.0.2260.0" )
            "bin/sqlcmd-11.0.2260.0" )
bin_sym=( bcp sqlcmd )
bin_perms=( 0755 0755 )
